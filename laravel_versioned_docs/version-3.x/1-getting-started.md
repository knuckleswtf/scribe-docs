...
[Here's the full documentation on configuring routes](/laravel/3.x/reference/config#routes).
...
Scribe can also generate a Postman collection and OpenAPI spec. See [generating documentation](/laravel/3.x/generating) for details.
...
You can set all these in the config file. For details, see [documenting API information](/laravel/3.x/documenting/api-information).
...
Check out how to do this in the guide on [Documenting your API](/laravel/3.x/documenting/).
