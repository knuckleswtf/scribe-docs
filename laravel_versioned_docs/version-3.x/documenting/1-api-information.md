...
:::tip
You can also edit the `.scribe/intro.md` file that is added to your app after running `scribe:generate`.
:::
...
:::tip
You can also edit the `.scribe/auth.md` file that is added to your app after running `scribe:generate`.
:::
