...
Thanks for using Scribe! We hope you have fun and write kickass API docs! And if you'd like to get better at API documentation, I;m making a course just for you: [shalvah.teachable.com/p/api-documentation-for-developers](https://shalvah.teachable.com/p/api-documentation-for-developers).
