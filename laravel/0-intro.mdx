...
Generate API documentation for humans from your Laravel/Lumen/[Dingo](https://github.com/dingo/api) codebase. See a live example at [sample.scribe.knuckles.wtf](https://sample.scribe.knuckles.wtf).
...
- [What's new in v3](/blog/laravel-v3)
- [Migrating from mpociot/laravel-apidoc-generator](migrating/legacy), or
:::
