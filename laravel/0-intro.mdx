...
Generate API documentation for humans from your Laravel/Lumen/[Dingo](https://github.com/dingo/api) codebase. [Here's a live example](https://shalvah.me/TheCensorshipAPI/).
